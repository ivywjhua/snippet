...
//	private static final String CONTEXT_PATH = "http://localtest:7070/makecard-web2.0";
	private static final String CONTEXT_PATH = "http://ppcoss.shengpay.com/makecard-web2.0";
	private static ResourceLoader resourceLoader = new DefaultResourceLoader();

	public static void main(String[] args) throws IOException, SAXException {
		Long menuIdStart = 168192L;
		Long privIdStart = 60613L;
		int seqIncr = 20;
	...
	static Menu parseMenu() throws IOException, SAXException {
		Resource resource = resourceLoader.getResource("makecard-uam.xml");
	...
	private static void generateSeqSql(Long menuIdStart, int seqIncr, Long sqlId)
		...
		FileUtils.writeStringToFile(new File("data/sql/mc2_seq.sql"),
...
//			privSql.append("-- " + m.getName() + " priv sql \n");
		...
		FileUtils.writeStringToFile(new File("data/sql/mc2_menu.sql"),
				menuSql.toString(), CharEncoding.UTF_8);
		FileUtils.writeStringToFile(new File("data/sql/mc2_priv.sql"),
	...
	private static void genrateDelSql(Long menuIdStart, Long privIdStart,
		...
		FileUtils.writeStringToFile(new File("data/sql/mc2_del.sql"),
